...
public class Blueprint : MonoBehaviour
{
    ...
    private void AdjustToMinimumTerrainHeight(GameObject nodeGameObject)
    {
        ...
        float terrainHeight = Environment.GetTerrain().SampleHeight(nodeGameObject.transform.position);
    ...
    void Update()
    {
        ...
        if (blueprintMode == BlueprintModes.rotating || blueprintMode == BlueprintModes.expanding)
        {
            ...
            if (mhi.IsHit() && mhi.hoverObject == Environment.GetTerrain().gameObject){
				Debug.Log ("mhi!");
