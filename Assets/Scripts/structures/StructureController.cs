...
public class StructureController : MonoBehaviour
{
		...
		/// <summary>
		/// Changes the Y component of the current position so that it lines up with terrain.
		/// </summary>
		public void SetAltitudeToMatchTerrain ()
		{
				TerrainManager tm = FindObjectOfType<TerrainManager> ();
				float altitude = tm.GetHeightAtPoint (transform.position);
